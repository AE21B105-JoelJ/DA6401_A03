# Sweep file for attention based Seq2Seq model #
...
sweep_id = wandb.sweep(sweep=sweep_config, project="Attention_RNN", entity="A3_DA6401_DL")
wandb.agent(sweep_id, function=run_sweep,project="Attention_RNN", entity="A3_DA6401_DL")